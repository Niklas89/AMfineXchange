...
<div style="float:left;">
	...
	<?php echo $this->Html->image($photo, array('alt' => $me['User']['username'])); ?>
</div>
...
<div style="float:left;text-align:left;margin-left:20px;">
	...
	<div>
		<p class="statut"><?php echo $me['User']['firstname'] ?> <?php echo $me['User']['lastname'] ?></p>
	</div>
	<div>
		<p class="statut">Profession: <?php echo $me['User']['fonction'] ?></p>
	</div>
	<div>
		<p class="statut">Membre: <?php echo $me['User']['membership'] ?></p>
	</div>
	<!-- <div>
